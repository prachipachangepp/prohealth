...
///for email textfield only
class SMTextFConstEmail extends StatefulWidget {
  ...
  @override
  State<SMTextFConstEmail> createState() => _SMTextFConstEmailState();
}

class _SMTextFConstEmailState extends State<SMTextFConstEmail> {
  @override
