                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(color: Color(0xFF686464), width: 1),
                      ...
                      FutureBuilder<List<SearchEmployeeProfileData>>(
                        future: "Sujata".contains(RegExp(r'^[0-9]*$'))
                            ? getSearchProfileById(context, 5, int.parse("Sujata"))
                            : getSearchProfileByText(context, 5, "Sujata"),
                        builder: (context, AsyncSnapshot<List<SearchEmployeeProfileData>> snapshot) {
