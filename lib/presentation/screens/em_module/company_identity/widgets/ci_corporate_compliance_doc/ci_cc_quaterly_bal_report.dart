...
class CICCQuarterlyBalReport extends StatefulWidget {
  ...
  const CICCQuarterlyBalReport({super.key, required this.docId, required this.subDocId, required this.officeId});
...
class _CICCQuarterlyBalReportState extends State<CICCQuarterlyBalReport> {
  ...
  final StreamController<List<MCorporateComplianceModal>> _ccQuarterlyController = StreamController<List<MCorporateComplianceModal>>();
          ...
          Expanded(
            ...
            StreamBuilder<List<MCorporateComplianceModal>>(
                ...
                builder: (context, snapshot) {
                  getListMCorporateCompliancefetch(context, AppConfig.corporateAndCompliance, AppConfig.subDocId5BalReport, 1, 20).then((data) {
                        ...
                        Expanded(
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                MCorporateComplianceModal balReport = paginatedData[index];
                                return Column(
                                              ...
                                              children: [
                                                  ...
                                                  children: [
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          balReport.expiry_date.toString(),textAlign:TextAlign.center,
                                                          style: GoogleFonts.firaSans(
                                                            fontSize: 10,
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                      ...
                                                      onPressed: () {
                                                        showDialog(
                                                          ...
                                                          builder: (context) => ManageHistoryPopup(
                                                            docHistory:  balReport.docHistory,
                                                          ),
                                                        );
                                                      },
                                                      icon: Icon(
                                                      ...
                                                      onPressed: () {
                                                        ...
                                                        showDialog(
                                                          ...
                                                          return FutureBuilder<MCorporateCompliancePreFillModal>(
                                                            future: getPrefillNewOrgOfficeDocument(context, balReport.orgOfficeDocumentId),
                                                    ...
                                                    //           future: getManageCCPrefill(context, balReport.docId),
                                                    //           builder: (context, snapshotPrefill) {
                                                    //             if (snapshotPrefill.connectionState == ConnectionState.waiting) {
                                                    //               return Center(
                                                    //                 child: CircularProgressIndicator(
                                                    ...
                                                    //                       }
                                                    //                       if (snapshot.hasData) {
                                                    //                         String selectedDocType = "Quarterly Balance Report";
                                                    //                         int docType = snapshot.data![0].docID;
                                                    //
                                                    //                         for (var i in snapshot.data!) {
                                                    //                           if (i.docID == AppConfig.subDocId5BalReport) {
                                                    //                             selectedDocType = i.docType;
                                                    //                             docType = i.docID;
                                                    //                             break;
                                                    //                           }
                                                                ...
                                                                builder: (BuildContext context, void Function(void Function()) setState) {
                                                                  return  DeletePopup(
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      setState(() async {
                                                                        await   await getListMCorporateCompliancefetch(context,
