...
class MobileVerifyOtpScreen extends StatefulWidget {
  final String email;
  const MobileVerifyOtpScreen({Key? key, required this.email})
      : super(key: key);

  @override
  State<MobileVerifyOtpScreen> createState() => _MobileVerifyOtpScreenState();
}

class _MobileVerifyOtpScreenState extends State<MobileVerifyOtpScreen> {
