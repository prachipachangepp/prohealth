...
// import 'package:prohealth/presentation/screens/tablet_module/login_screen_flow/tab_new_password.dart';
...
//
// class TabVerifyPasswordScreen extends StatefulWidget {
//   final String email;
//   const TabVerifyPasswordScreen({super.key, required this.email});
//
//   @override
//   State<TabVerifyPasswordScreen> createState() => _TabVerifyPasswordScreenState();
// }
//
// class _TabVerifyPasswordScreenState extends State<TabVerifyPasswordScreen> {
...
//       Navigator.push(
//         context,
//         MaterialPageRoute(builder: (context) => TabNewPassScreen(email: email, otp: otp)),
//       );
//     } else {
//       setState(() {
