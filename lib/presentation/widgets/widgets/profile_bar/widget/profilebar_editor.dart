...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return StatefulBuilder(
      builder: (BuildContext context, void Function(void Function()) setState) { return   FutureBuilder<ProfileEditorModal>(
                                      ...
                                      FutureBuilder <EmployeeModel>(future: getCoverageList(context: context, employeeId: widget.employeeId,
                                          ...
                                          builder: (context ,snapshot){
                                            ...
                                            if (snapshot.hasData){
                                                                  ...
                                                                  builder: (BuildContext context, void Function(void Function()) setState) {
                                                                    return Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          snapshot.data!.coverageDetails[index].countyName,
                                                                        ...
                                                                        Text(
                                                                          snapshot.data!.coverageDetails[index].zoneName,
                                                                          style: EditTextFontStyle.customEditTextStyle(),
                                                                        ),
                                                                        SizedBox(
                                                                          width: 5,
                                              ...
                                              //   itemCount: snapshot.data!.coverageDetails.length,
                                              ...
                                              //                     width: 3,
                                              //                   ),
                                              //                   Text( snapshot.data!.coverageDetails[index].countyName,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          InkWell(
                                            onTap: (){showDialog(
                                                context: context,
                                                builder: (BuildContext context)=> ProfileBarAddPopup(employeeId: widget.employeeId,
                                                  employeeEnrollId: profileData.employeeEnrollId, onRefresh: () {
                                                    setState(() {
                                                      getCoverageList(context: context, employeeId: widget.employeeId,
                                                          employeeEnrollId:profileData.employeeEnrollId );
                                                    });
