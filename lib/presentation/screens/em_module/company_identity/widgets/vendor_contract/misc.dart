...
class _CiMiscState extends State<CiMisc> {
  ...
  final StreamController<List<ManageCCDoc>> vendorMISCController = StreamController<List<ManageCCDoc>>();
                        ...
                        Expanded(
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                ManageCCDoc miscData = paginatedData[index];
                                return Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          miscData.docname.toString().capitalizeFirst!,textAlign:TextAlign.center,
                                                          style: GoogleFonts.firaSans(
                                                            fontSize: 10,
