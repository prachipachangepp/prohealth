  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: FutureBuilder<ManageDetails>(
        future: companyDetailGetAll(context,11,"1"),
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            SMTextFConst(
                              controller:  TextEditingController(text: snapshot.data!.officeName.toString()),
                              keyboardType: TextInputType.text,
                              text: AppStringEM.officename,
                            ),
                            SizedBox(height: AppSize.s10),
                            SMTextFConst(
                              controller: TextEditingController(text: snapshot.data!.secNumber.toString()),
                              keyboardType: TextInputType.number,
                              text: AppStringEM.secNum,
                            ),
                            SizedBox(height: AppSize.s10),
                            SMTextFConst(
                              controller: TextEditingController(text: snapshot.data!.address.toString()),
                              keyboardType: TextInputType.text,
                        ...
                        Column(
                          ...
                          children: [
                            SMTextFConst(
                              controller: TextEditingController(text: snapshot.data!.priNumber.toString()),
                              keyboardType: TextInputType.number,
                              text: AppStringEM.primNum,
                            ),
                            SizedBox(height: AppSize.s10),
                            SMTextFConst(
                              controller: TextEditingController(text: snapshot.data!.alternateNumber.toString()),
                              keyboardType: TextInputType.number,
                              text: AppStringEM.alternatephone,
                            ),
                            SizedBox(height: AppSize.s10),
                            SMTextFConst(
                              controller: TextEditingController(text: snapshot.data!.email.toString()),
                              keyboardType: TextInputType.text,
