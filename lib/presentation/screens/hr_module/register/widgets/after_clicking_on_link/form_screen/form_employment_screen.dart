...
class _Employment_screenState extends State<Employment_screen> {
  ...
  Widget build(BuildContext context) {
    ...
    // FutureBuilder<List<EmploymentDataForm>>(
    // future: getEmployeeHistoryForm(context, widget.employeeID),
    ...
    // }
    // if (snapshot.hasData) {
    // List<EmploymentDataForm>? data = snapshot.data;
    // //print{::::::::=> "$snapshot.data"};
    // print(":::::: :=>${snapshot.data!}");
    ...
    // text: snapshot.data![index].employer);
    ...
    // text: snapshot.data![index].supervisor);
    // supervisorMobileNumberController = TextEditingController(
    // text: snapshot.data![index].supMobile);
    // finalPositionController = TextEditingController(
    // text: snapshot.data![index].title);
    // startDateController = TextEditingController(
    // text: snapshot.data![index].dateOfJoining);
...
class _EmploymentFormState extends State<EmploymentForm> {
  ...
  // TextEditingController newFormReasonForLeavingController =
  //     TextEditingController();
  // TextEditingController newFormSupervisorNameController =
  //     TextEditingController();
  // TextEditingController newFormSupervisorMobileNumberController =
  //     TextEditingController();
  // TextEditingController newFormFinalPositionController =
  //     TextEditingController();
...
//   const Employment_screen({
//     super.key,
//     required this.context, this.filepath,
//   });
//
//   final BuildContext context;
//
