...
class _CiSnfState extends State<CiSnf> {
  ...
  final StreamController<List<ManageCCDoc>> vendorSnfController = StreamController<List<ManageCCDoc>>();
                        ...
                        Expanded(
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                ManageCCDoc snfData = paginatedData[index];
                                return Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          snfData.docname.toString().capitalizeFirst!,textAlign:TextAlign.center,
                                                          style: GoogleFonts.firaSans(
                                                            fontSize: 10,
