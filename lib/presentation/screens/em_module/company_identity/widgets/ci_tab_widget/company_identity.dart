                      ...
                      return StreamBuilder<List<CompanyIdentityModel>>(
                        ...
                        builder: (BuildContext context, snapshot) {
                          ...
                          if (snapshot.hasData) {
                            ...
                            int endIndex = (currentPage * itemsPerPage) > totalItems
                                ? totalItems
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          CustomButtonTransparentSM(
                                            text: 'Manage',
                                            onPressed: () {
                                              print(snapshot.data![index].officeId);
                                              print("Is office id");
                                              showManageScreenFunction(
                                                officeId: snapshot.data![index].officeId,
                                                officeName: snapshot.data![index].officeName,
