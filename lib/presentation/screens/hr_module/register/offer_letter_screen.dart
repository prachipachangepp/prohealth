            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsets.only(top: 20.0, bottom: 20, left: 105),
                    child: Row(
                              ...
                              children: [
                                Text(
                                  hrProviderState.salary.isNotEmpty
                                      ...
                                      : "Not Defined",
                                  style: DropdownItemStyle.customTextStyle(
                                      context),
                                ),
                                const SizedBox(width: 30),
                                Row(
                                  ...
                                  onConfirm: () async {
                                    ...
                                    try {
                                      ...
                                      if (depId == AppConfig.salesId ||
                                        ...
                                        patientsValue = int.parse(patientsController
                                            .text); // Otherwise, parse the text from the controller
                                      }
                                      print(
                                          'selected county ID:::::::::::::::***** ${countyId}');
                                      ...
                                      if (response.statusCode == 200 ||
                                        ...
                                        Navigator.pop(context);
                                        if (empEnrollOfferResponse.statusCode ==
                                                200 ||
                                            empEnrollOfferResponse.statusCode ==
                                                201) {
                                          showDialog(
                                            context: context,
                                            builder: (BuildContext context) {
          ...
          CustomTextFieldOfferScreen(
            ...
            onChanged: (value) {
              hrProviderState.validateFields(
                  validationLabel: validationLabel, value: value);
              // setState(() {
