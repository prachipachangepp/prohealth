...
class _CICCQuarterlyBalReportState extends State<CICCQuarterlyBalReport> {
  ...
  final StreamController<List<ManageCCDoc>> _ccQuarterlyController = StreamController<List<ManageCCDoc>>();
            ...
            StreamBuilder<List<ManageCCDoc>>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.data!.isEmpty) {
                    return Center(
                      child: Text(
                        "No available quaterly balance reports !!",
                        ...
                        Expanded(
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                ManageCCDoc balReport = paginatedData[index];
                                return Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          balReport.docname.toString(),textAlign:TextAlign.center,
                                                          style: GoogleFonts.firaSans(
                                                            fontSize: 10,
