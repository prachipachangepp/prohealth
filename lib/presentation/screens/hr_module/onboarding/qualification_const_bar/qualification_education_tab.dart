                        ...
                        Row(
                          ...
                          children: [
                            const Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                InfoText('College/ University',TextStyle()),
                                InfoText('Graduate',TextStyle()),
                                InfoText('Degree',TextStyle()),
                                InfoText('Major Subject',TextStyle()),
                              ],
                            ),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                InfoData(snapshot.data![index].college,TextStyle()),
                                InfoData(snapshot.data![index].graduate,TextStyle()),
                                InfoData(snapshot.data![index].degree,TextStyle()),
                                InfoData(snapshot.data![index].major,TextStyle()),
                              ],
                            ),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                InfoText('Phone',TextStyle()),
                                InfoText('City',TextStyle()),
                                InfoText('State',TextStyle()),
                              ],
                            ),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                InfoData(snapshot.data![index].phone,TextStyle()),
                                InfoData(snapshot.data![index].city,TextStyle()),
                                InfoData(snapshot.data![index].state,TextStyle()),
                              ],
                            ),
                          ],
                        ),
