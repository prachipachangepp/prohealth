                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          CiOrgDocumentCC costData = paginatedData[index];
                          return Column(
                            children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Center(
                                        child: Text(
                                          costData.name.toString().capitalizeFirst!,
                                          style: GoogleFonts.firaSans(
                                            fontSize: 10,
                                            fontWeight: FontWeight.w700,
                                            color: Color(0xff686464),
                                              ...
                                              showDialog(
                                                ...
                                                builder: (context) {
                                                  return FutureBuilder<CorporatePrefillDocumentData>(
                                                    future: getPrefillCorporateDocument(context,costData.docId),
