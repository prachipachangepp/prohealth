        ...
        Expanded(
          child:StreamBuilder<List<NewOrgDocument>>(
              ...
              builder: (context, snapshot) {
                getNewOrgDocfetch(context,AppConfig.vendorContracts,AppConfig.subDocId9MD,1,50).then((data) {
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            NewOrgDocument capsdata = paginatedData[index];
                            return Column(
                              children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Center(
                                            child: Text(
                                              capsdata.docName.toString().capitalizeFirst!,
                                              style: GoogleFonts.firaSans(
                                                  fontSize: 10,
                                                  fontWeight: FontWeight.w700,
                                                  color: Color(0xff686464)
                                      ...
                                      Expanded(
                                        child: Center(
                                            child: Text(
                                              capsdata.expiryReminder.toString().capitalizeFirst!,
                                              style: GoogleFonts.firaSans(
                                                  fontSize: 10,
                                                  fontWeight: FontWeight.w700,
                                                  color: Color(0xff686464)
                                                ...
                                                showDialog(
                                                  ...
                                                  builder: (context) {
                                                    return FutureBuilder<CorporatePrefillDocumentData>(
                                                      future: getPrefillCorporateDocument(context,capsdata.orgDocumentSetupid),
