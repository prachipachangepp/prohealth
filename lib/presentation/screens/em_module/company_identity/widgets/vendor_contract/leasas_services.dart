...
class _CiLeasesAndServicesState extends State<CiLeasesAndServices> {
  ...
  final StreamController<List<MCorporateComplianceModal>> vendorLeasesController =
 ...
 // int docTypeMetaId = 0;
  ...
  void initState() {
    getListMCorporateCompliancefetch(context,
        AppConfig.vendorContracts, AppConfig.subDocId6Leases, 1, 20
    )
        .then((data) {
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    IconButton(onPressed: (){
                                                      ...
                                                      DowloadFile().downloadPdfFromBase64(fileExtension,"Leases.pdf");
