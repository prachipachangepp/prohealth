...
// import 'package:prohealth/presentation/widgets/login_screen/widgets/login_flow_base_struct.dart';
//
// import '../../../../app/services/api/confirm_pass/confirm_pass_manager.dart';
//
// class ChangePasswordScreen extends StatefulWidget {
//   final String otp;
//
//   ChangePasswordScreen({Key? key, required this.otp}) : super(key: key);
//
//   @override
//   State<ChangePasswordScreen> createState() => _ChangePasswordScreenState();
// }
...
//   FocusNode confirmpassFocusNode = FocusNode();
//   String? _errorMessage;
//   ConfirmPassManager _confirmPassManager = ConfirmPassManager();
//
//   @override
//   Widget build(BuildContext context) {
//     return LoginBaseConstant(
...
//                         }
//                         try {
//                           await _confirmPassManager.confirmPassword(
//                               'pardeshisaloni22@gmail.com',
//                               widget.otp,
