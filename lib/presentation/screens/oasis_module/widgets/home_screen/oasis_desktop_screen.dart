...
import '../../../../../data/api_data/hr_module_data/employee_profile/search_profile_data.dart';
...
import '../../../hr_module/see_all_hr/see_all_hr_screen.dart';
import '../../oasis_dashbord/dashboard_screen.dart';
import '../../oasis_live_feed/live_feed_screen.dart';
import '../../oasis_patient_charts/patient_chart_screen.dart';
import '../../oasis_patient_profile/patient_profile_screen.dart';

class EMRDesktopScreen extends StatefulWidget {
  const EMRDesktopScreen({super.key});
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ///log appbar
            ApplicationAppBar(headingText: "Home Health EMR"),
