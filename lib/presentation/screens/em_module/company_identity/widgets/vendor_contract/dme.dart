...
class _CiDmeState extends State<CiDme> {
  ...
  final StreamController<List<ManageCCDoc>> vendorDMEController = StreamController<List<ManageCCDoc>>();
                        ...
                        Expanded(
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                ManageCCDoc dmeData = paginatedData[index];
                                return Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          dmeData.docname.toString().capitalizeFirst!,textAlign:TextAlign.center,
                                                          style: GoogleFonts.firaSans(
                                                            fontSize: 10,
