...
//                     }
//                     if (snapshot.hasData) {
//                       Map<String, int> vendorMap = {};
//                       List<DropdownMenuItem<String>> dropDownMenuItems = [];
//
//                       for (var vendor in snapshot.data!) {
//                         vendorMap[vendor.vendorName!] = vendor.insuranceVendorId!;
...
//
//                       return CICCDropdown(
//                         initialValue: selectedVendorName ?? 'Vendor Contract',
//                         onChange: (val) {
//                           setState(() {
//                             selectedVendorName = val;
//                             selectedVendorId = vendorMap[val];
//                             isAddButtonEnabled = selectedVendorId != null;
...
//                   CiInsuranceContract(
//                     insuranceVendorId: selectedVendorId ?? 4,
