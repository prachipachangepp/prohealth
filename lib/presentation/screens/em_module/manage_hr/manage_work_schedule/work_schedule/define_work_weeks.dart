...
final StreamController<List<WorkWeekShiftScheduleData>> workWeekShiftController =
...
void initState() {
  ...
  workWeekShiftScheduleGet(context).then((data) {
                                        ...
                                        children: [
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: Center(child: Row(
                                                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                                    children: [
                                                      Text(data.officeStartTime,style: GoogleFonts.firaSans(
                                                ...
                                                Container(
                                                  ...
                                                  child: Center(child: Row(
                                                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                                    children: [
                                                      Text(data.officeEndTime,style: GoogleFonts.firaSans(
                                                        fontSize: mediaQuery.width/115,
                                                        fontWeight: FontWeightManager.semiBold,
                                                        color: ColorManager.mediumgrey,
                                                        decoration: TextDecoration.none,
                                          ...
                                          Container(
                                            ...
                                            child: ScrollConfiguration(
                                              ...
                                              child: StreamBuilder<List<WorkWeekShiftScheduleData>>(
                                                stream: workWeekShiftController.stream,
                                                                ...
                                                                child: Container(
                                                                  ...
                                                                  child: Padding(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        Text(snapshotShift.data![index].shiftName,style: GoogleFonts.firaSans(
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child: Center(child: Text(snapshotShift.data![index].officeStartTime,style: GoogleFonts.firaSans(
                                                                            fontSize: mediaQuery.width/115,
                                                                            fontWeight: FontWeightManager.semiBold,
                                                                            color: ColorManager.mediumgrey,
                                                                            decoration: TextDecoration.none,
                                                                        ...
                                                                        InkWell(
                                                                          ...
                                                                          child:
                                                                          Text('10+ Batches more',style: GoogleFonts.firaSans(
                                                                            fontSize: mediaQuery.width/115,
