...
class TabNewPassScreen extends StatefulWidget {
  final String email;
  final String otp;
  const TabNewPassScreen({super.key, required this.email, required this.otp});

  @override
  State<TabNewPassScreen> createState() => _TabNewPassScreenState();
}

class _TabNewPassScreenState extends State<TabNewPassScreen> {
                                  ...
                                  children: [
                                    ...
                                    CustomButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(builder: (context) => TabLoginScreen()),
                                        );
                                      },
                                    )
                                  ],
