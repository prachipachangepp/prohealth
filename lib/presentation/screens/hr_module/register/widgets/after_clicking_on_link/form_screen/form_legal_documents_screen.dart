            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  DefineFormList(
                    formName: AppStringLegalDocument.candidatereLeaseForm,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.onCall,
                    onPressed: () async {
                      OnCallDocument onCallDocument =
                          await getLegalOnCallDocument(
                        context: context,
                        callHtmlId: 1,
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (_) => SignatureFormScreen(
                                    ...
                                    onPressed: () {},
                                    htmlFormData:
                                        onCallDocument.onCallData.toString(),
                                  )));
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.confidentialityAgreement,
                    onPressed: () async {
                      ConfidentialStatementDocument
                          confidentialStatementDocument =
                          await getLegalConfidentialStatementDocument(
                              context: context,
                              ConfidentialStatementId: 1,
                              employeeId: widget.employeeID);
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => SignatureFormScreen(
                                    documentName: AppStringLegalDocument.onCall,
                                    onPressed: () {},
                                    htmlFormData: confidentialStatementDocument
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.covidTestingPolicy,
                    onPressed: () async {
                      CovidTestPolicyDocument covidTestPolicyDocument =
                          await getLegalCovidTestPolicyDocument(
                              context: context,
                              covidTestId: 1,
                              employeeId: widget.employeeID);
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (_) => SignatureFormScreen(
                                    documentName: AppStringLegalDocument.onCall,
                                    onPressed: () {},
                                    htmlFormData: covidTestPolicyDocument
                                        .covidTestData
                                        .toString(),
                                  )));
                    },
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.policyConcerning,
                    onPressed: () async {
                      PolicyConcerningDocument policyConcerningDocument =
                          await getLegalpolicyConcerningDocument(
                              context: context,
                              policyConcerningId: 1,
                              employeeId: widget.employeeID);
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => SignatureFormScreen(
                                    documentName: AppStringLegalDocument.onCall,
                                    onPressed: () {},
                                    htmlFormData: policyConcerningDocument
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.reportOfAbuse,
                    onPressed: () async {
                      ReportingAbuseDocument reportingAbuseDocument =
                          await getLegalReportingAbuseDocumentDocument(
                              context: context,
                              reportingAbuseId: 1,
                              employeeId: widget.employeeID);
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (_) => SignatureFormScreen(
                                    documentName: AppStringLegalDocument.onCall,
                                    onPressed: () {},
                                    htmlFormData: reportingAbuseDocument
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.personalOrientation,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.directDeposit,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.standardOfCodeOfConduct,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.sexualHarassmentPolicy,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.sexualHarassmentPolicyACK,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.preAuthorization,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.prop65,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.returnOfcompanyProperty,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.hepB,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.tDap,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.flu,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.covidVaccine,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.i9,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.w4,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                  ...
                  const SizedBox(height: AppSize.s10),
                  DefineFormList(
                    formName: AppStringLegalDocument.employeeHandbook,
                    onPressed: () {},
                    onPressedView: () {},
                  ),
                  const SizedBox(height: AppSize.s10),
                        ...
                        if (finalPath == null || finalPath.isEmpty) {
                          ...
                          try {
                            ...
                            var response = await uploadLegalDocumentBase64(
                                context: context,
                                employeeLegalDocumentId:
                                    result.legalDocumentId!,
