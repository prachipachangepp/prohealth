  ...
  Future<Map<String, dynamic>> getCompany(int companyId) async {
    try {
      ...
      var response = await dio.get(
        ...
        //'https://wwx3rebc2b.execute-api.us-west-1.amazonaws.com/dev/serverlessSetup/establishment/company/$companyId',
      );

      if (response.statusCode == 200) {
        return response.data;
      } else {
        throw Exception('Failed to load company: ${response.statusMessage}');
      }
    } catch (e) {
...
//
//   //
//   // Future<CompanyDataGet> getCompanyById(int companyId) async {
//   //   try {
//   //     var response = await dio.request(
//   //       '${AppConfig.endpoint}/establishment/company/1',
//   //       //'https://wwx3rebc2b.execute-api.us-west-1.amazonaws.com/dev/serverlessSetup/establishment/company/$companyId',
